...
def drive(cfg, model_path=None, use_joystick=False, model_type=None,
    ...
    if camera_type == "stereo":
        ...
        V.add(StereoPair(), inputs=['cam/image_array_a', 'cam/image_array_b'],
            outputs=['cam/image_array_initial'])
    ...
    V.add(ctr,
        inputs=['cam/image_array_initial', 'tub/num_records'],
        outputs=['user/angle', 'user/throttle', 'user/mode', 'recording'],
        threaded=True)

    from donkeycar.parts.preprocess import Preprocess_image
    V.add(Preprocess_image(160, 120), inputs = ['cam/image_array_initial'], outputs = ['cam/image_array'])
    ...
    if cfg.CAR_DETECTOR:
        ...
        V.add(CarDetector(cfg.CAR_SHOW_BOUNDING_BOX, cfg.CAR_THRESHOLD), inputs=['cam/image_array_initial', 'user/throttle'], outputs=['user/throttle', 'cam/image_array_initial'])

    if cfg.IS_COLOR_DETECTOR:
        from donkeycar.parts.red_detect import Red_Detect
        V.add(Red_Detect(160, 120), inputs=['cam/image_array_initial','user/throttle'], outputs=['user/throttle','cam/image_array_initial'])
    ...
    if cfg.PUB_CAMERA_IMAGES:
        ...
        V.add(ImgArrToJpg(), inputs=['cam/image_array_initial'], outputs=['jpg/bin'])
